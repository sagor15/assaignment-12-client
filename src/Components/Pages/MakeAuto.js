...
const MakeAuto = () => {
    return (
        <section className='mt-10'>
            <h1 className='text-primary text-3xl text-center py-5'>Made on Auto</h1>
        <div style={{background:`url(${Appointment})` ,backgroundSize:'cover', backgroundRepeat: 'no-reapet', backgroundAttachment:'fixed'}} className='flex mt-[150px] justify-center items-center'>
            ...
            <div className='flex-1 px-5'>
                ...
                <h2 className='text-white text-3xl text-bold'>Make an auto Today</h2>
